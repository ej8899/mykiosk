      ...
      <div className="dark flex flex-row items-center justify-center mr-8 ml-8 ">
          ...
          <div className="flex flex-col gap-4 w-full">
            <div className="flex flex-col gap-4 mr-4 mt-4">
              <h1 className="text-2xl font-bold text-white">Upcoming Milestones...</h1>
              <Card className="border-l-8 dark:border-blue-500 bg-transparent">
                <div className="flex flex-col gap-2">
                  <h2 className="text-lg font-bold text-white">Event 11</h2>
          ...
          <div className="h-56 sm:h-64 xl:h-80 2xl:h-96 w-full ml-4">
            <h1 className="text-2xl font-bold text-white">Happening on Site...</h1>
