...
const Footer = () => {
  ...
  return (
    ...
    <div className="bg-gray-800 text-white p-4 flex flex-row items-center justify-between px-4 bg-opacity-45 text-5xl font-thin">
...
function PinIcon(props) {
  return (
    <svg className="w-16 h-16 text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
